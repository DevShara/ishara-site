...
const Contact = lazy(() => import("./assets/Contact.cf0a8089.mjs"));
const Works = lazy(() => import("./assets/Works.476424cd.mjs"));
const Skills = lazy(() => import("./assets/Skills.d417540e.mjs"));
const About = lazy(() => import("./assets/About.e7e09193.mjs"));
const Navbar = lazy(() => import("./assets/Navbar.03a06b27.mjs"));
const Hero = lazy(() => import("./assets/Hero.263eece9.mjs"));
const App = () => {
